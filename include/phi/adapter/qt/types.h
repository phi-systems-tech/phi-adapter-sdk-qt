// Qt-facing wrapper layer over the canonical phi-adapter-sdk v1 contract.
// Source of truth for adapter contract semantics lives in phi-adapter-sdk
// (`phi::adapter-contract`, headers under phi/adapter/v1/*).
//
// This is the single shared copy, packaged as `phi::adapter-contract-qt` in
// phi-adapter-sdk-qt. phi-core and Qt-based adapters consume it from here;
// per-repo copies are not allowed. It must not evolve into an independent
// second contract definition (static_asserts below pin it to v1).
#pragma once
...
struct ActionResponse {
    ...
    QVariantMap formValues;                // Optional form value updates (field key -> value)
    QVariantMap fieldChoices;              // Optional field choices patch (field key -> [{value,label},...])
    bool reloadLayout = false;             // Optional request to reload action/config layout
    qint64    tsMs   = 0;                  // Optional timestamp (ms since epoch)
};
...
enum class ChannelKind : quint16 {
    ...
    MotionSensitivity     = 69,  // Motion sensor sensitivity profile, ChannelDataType::Enum
...
enum class AdapterConfigLabelPosition : quint8 {
    Top   = 0,
    Left  = 1,
    Right = 2
};
Q_ENUM_NS(AdapterConfigLabelPosition)

enum class AdapterConfigActionPosition : quint8 {
    None   = 0,
    Inline = 1,
    Below  = 2
};
Q_ENUM_NS(AdapterConfigActionPosition)

enum class AdapterConfigVisibilityOp : quint8 {
    Equals   = 0,
    Contains = 1
};
Q_ENUM_NS(AdapterConfigVisibilityOp)
...
namespace phicore::adapter {
static_assert(static_cast<int>(CmdStatus::Success) == static_cast<int>(v1::CmdStatus::Success));
static_assert(static_cast<int>(CmdStatus::Failure) == static_cast<int>(v1::CmdStatus::Failure));
static_assert(static_cast<int>(CmdStatus::Timeout) == static_cast<int>(v1::CmdStatus::Timeout));
static_assert(static_cast<int>(CmdStatus::NotSupported) == static_cast<int>(v1::CmdStatus::NotSupported));
static_assert(static_cast<int>(CmdStatus::InvalidArgument) == static_cast<int>(v1::CmdStatus::InvalidArgument));
static_assert(static_cast<int>(CmdStatus::Busy) == static_cast<int>(v1::CmdStatus::Busy));
static_assert(static_cast<int>(CmdStatus::TemporarilyOffline) == static_cast<int>(v1::CmdStatus::TemporarilyOffline));
static_assert(static_cast<int>(CmdStatus::NotAuthorized) == static_cast<int>(v1::CmdStatus::NotAuthorized));
static_assert(static_cast<int>(CmdStatus::NotImplemented) == static_cast<int>(v1::CmdStatus::NotImplemented));
static_assert(static_cast<int>(CmdStatus::InternalError) == static_cast<int>(v1::CmdStatus::InternalError));

static_assert(static_cast<int>(ChannelKind::PowerOnOff) == static_cast<int>(v1::ChannelKind::PowerOnOff));
static_assert(static_cast<int>(ChannelKind::Brightness) == static_cast<int>(v1::ChannelKind::Brightness));
static_assert(static_cast<int>(ChannelKind::ColorTemperature) == static_cast<int>(v1::ChannelKind::ColorTemperature));
static_assert(static_cast<int>(ChannelKind::ColorRGB) == static_cast<int>(v1::ChannelKind::ColorRGB));
static_assert(static_cast<int>(ChannelKind::Motion) == static_cast<int>(v1::ChannelKind::Motion));
static_assert(static_cast<int>(ChannelKind::ConnectivityStatus) == static_cast<int>(v1::ChannelKind::ConnectivityStatus));
static_assert(static_cast<int>(ChannelKind::AmbientLightLevel) == static_cast<int>(v1::ChannelKind::AmbientLightLevel));
static_assert(static_cast<int>(ChannelKind::MotionSensitivity) == static_cast<int>(v1::ChannelKind::MotionSensitivity));
static_assert(static_cast<int>(ChannelKind::SceneTrigger) == static_cast<int>(v1::ChannelKind::SceneTrigger));

static_assert(static_cast<int>(ChannelDataType::Bool) == static_cast<int>(v1::ChannelDataType::Bool));
static_assert(static_cast<int>(ChannelDataType::Int) == static_cast<int>(v1::ChannelDataType::Int));
static_assert(static_cast<int>(ChannelDataType::Float) == static_cast<int>(v1::ChannelDataType::Float));
static_assert(static_cast<int>(ChannelDataType::String) == static_cast<int>(v1::ChannelDataType::String));
static_assert(static_cast<int>(ChannelDataType::Color) == static_cast<int>(v1::ChannelDataType::Color));
static_assert(static_cast<int>(ChannelDataType::Enum) == static_cast<int>(v1::ChannelDataType::Enum));

static_assert(static_cast<int>(ConnectivityStatus::Unknown) == static_cast<int>(v1::ConnectivityStatus::Unknown));
static_assert(static_cast<int>(ConnectivityStatus::Connected) == static_cast<int>(v1::ConnectivityStatus::Connected));
static_assert(static_cast<int>(ConnectivityStatus::Limited) == static_cast<int>(v1::ConnectivityStatus::Limited));
static_assert(static_cast<int>(ConnectivityStatus::Disconnected) == static_cast<int>(v1::ConnectivityStatus::Disconnected));

static_assert(static_cast<int>(AdapterConfigFieldType::String) == static_cast<int>(v1::AdapterConfigFieldType::String));
static_assert(static_cast<int>(AdapterConfigFieldType::Action) == static_cast<int>(v1::AdapterConfigFieldType::Action));

static_assert(static_cast<int>(AdapterRequirement::UsesRetryInterval) == static_cast<int>(v1::AdapterRequirement::UsesRetryInterval));
static_assert(static_cast<int>(AdapterFlag::AdapterFlagSupportsDiscovery) == static_cast<int>(v1::AdapterFlag::SupportsDiscovery));
static_assert(static_cast<int>(AdapterFlag::AdapterFlagEnableLogs) == static_cast<int>(v1::AdapterFlag::EnableLogs));

static_assert(static_cast<int>(ChannelFlag::ChannelFlagReadable) == static_cast<int>(v1::ChannelFlag::Readable));
static_assert(static_cast<int>(ChannelFlag::ChannelFlagWritable) == static_cast<int>(v1::ChannelFlag::Writable));
static_assert(static_cast<int>(ChannelFlag::ChannelFlagReportable) == static_cast<int>(v1::ChannelFlag::Reportable));
static_assert(static_cast<int>(ChannelFlag::ChannelFlagRetained) == static_cast<int>(v1::ChannelFlag::Retained));
static_assert(static_cast<int>(ChannelFlagDefaultWrite) == static_cast<int>(v1::kChannelFlagDefaultWrite));
static_assert(static_cast<int>(ChannelFlagDefaultRead) == static_cast<int>(v1::kChannelFlagDefaultRead));
